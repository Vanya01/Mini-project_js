...
let postId =  document.getElementsByClassName('pg').innerText = `${post.id}`
let postBody =  document.getElementsByClassName('com_wrap').innerText = `${post.body}`
